...
```javascript
snrm2 = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-wasm-snrm2@v0.1.1-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/blas-base-wasm-snrm2/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/blas-base-wasm-snrm2/actions/workflows/test.yml?query=branch:v0.1.1

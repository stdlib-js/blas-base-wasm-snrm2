...
```javascript
import snrm2 from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-snrm2-wasm@esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { Module } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-snrm2-wasm@esm/index.mjs';
```
